...
export default function RandomTaylorSwiftSong() {
  ...
  return (
    <div
      className="flex justify-center items-center rounded-xl border-2 border-[#2f6e8b] h-full w-full p-8"
      style={{
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-6">
        <div>
          <button
            onClick={toggle}
            className="text-white mx-20 mb-10 bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-pink-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            {artist}
          </button>
        ...
        {!videoId && (
          <img src={ts} alt="description" height={190} width={190} />
        )}
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#1f5175] to-[#00344B]/80 border-2 border-[#2f6e8b]
